...
const coordinates = {
  ...
  "SOBRADINHO I": [-15.65056, -47.78538],
  ...
  "VILA TELEBRASILIA": [-15.847044993374613, -47.921330867411264],
  "VILA PLANALTO": [-15.793396918249677, -47.849610513824],
  "VARJÃO": [-15.709746155536749, -47.878501001075904],
  "PLANALTINA": [-15.623739311502135, -47.655367774426914],
  "ARAPOANGA": [-15.64254657240263, -47.63841749007564]
...
function highlightRegion(ra) {
  ...
  if (coord) {
    map.setView(coord, Math.max(map.getZoom(), 11));
  }
